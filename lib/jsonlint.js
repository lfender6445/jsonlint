...
var jsonlint = function () {
                ...
                _handleError:
                    if (typeof action === 'undefined' || !action.length || !action[0]) {
                        ...
                        while (1) {
                            ...
                            if (state === 0) {
                                window.lintError = errStr;
                                return false;    // throw new Error(errStr || 'Parsing halted.');
                            }
                            popStack(1);
                            state = stack[stack.length - 1];
                        }
    ...
    var lexer = function () {
        ...
        lexer.options = {};
        lexer.performAction = function anonymous(yy, yy_, $avoidingNameCollisions, YY_START) {
